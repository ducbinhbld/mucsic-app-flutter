...
class NowPlaying extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return NowPlaytingPage(songs: songs, playingSong: playingSong);
  }
}

class NowPlaytingPage extends StatefulWidget {
  const NowPlaytingPage(
      {super.key, required this.songs, required this.playingSong});
  final Song playingSong;
  final List<Song> songs;

  @override
  State<NowPlaytingPage> createState() => _NowPlaytingPageState();
}

class _NowPlaytingPageState extends State<NowPlaytingPage>
  ...
  Color? _getShuffleColor() {
    return _isShuffle ? Colors.grey : Colors.deepPurple;
  }
